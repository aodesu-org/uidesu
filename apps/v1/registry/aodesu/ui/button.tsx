...
const baseClasses =
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all shrink-0 outline-none disabled:pointer-events-none disabled:opacity-50 focus-visible:ring-[3px] focus-visible:ring-ring/50"
...
const iconSizeClasses: Record<ButtonSize, string> = {
  small: "size-8 rounded-md !px-0",
  medium: "size-10 rounded-lg !px-0",
  big: "size-12 rounded-xl !px-0",
}
